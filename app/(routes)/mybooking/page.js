...
import BookingHistoryLists from "./_component/BookingHistoryList";
    ...
    <div className='my-10 mx-5 md:mx-36'>
      ...
      <Tabs defaultValue="booked" className="w-full">
        ...
        <TabsContent value="booked">
          <BookingHistoryLists bookingHistory={filterData('booked')}/>
        </TabsContent>
        <TabsContent value="completed">
            <BookingHistoryLists bookingHistory={filterData('completed')}/>
            </TabsContent>
      </Tabs>
    </div>
  );
